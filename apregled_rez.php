  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="apregled_rez.php" class="nav-link">Преглед резервации</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate mb-5 pb-5 text-center text-md-left" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h3 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Преглед на резервации</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section">
            ...
            <table border=2 class="bordered">
                                ...
                                <th>Рута</th>  
                                    <th width="150">Име</th>
                                    <th width="150">Презиме</th>
                                    <th>Поаѓање</th>
                                    <th>Дестинација</th>
                                    <th>Време</th>
                                    <th width="150">Датум</th>
                                    <th>Цена</th>
                                    <th>Компанија</th>
                                </tr>
                                </thead> 
       ...
       $admin_pregled = ( "SELECT * FROM `patnik_rez` ORDER BY `patnik_rez`.`Рута` ASC");
      $result = $db->query($admin_pregled);
    ...
    ?>
    <tr>
    <td><?php print $row['Рута']; ?></td>
        <td><?php print $row['Име']; ?></td>
        <td><?php echo $row['Презиме']; ?></td>
